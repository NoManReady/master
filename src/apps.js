...
export default [
  {
    ...
    title: "小玥玥！！",
    desc: "炒鸡可爱的小屁孩",
    entry: isProd() ? "https://shuyue.131407.vip" : "//localhost:9001",
  ...
  },
  {
    ...
    title: "林🐷",
    desc: "我是一只无忧虑，憨憨的Pig",
    entry: isProd() ? "https://linqin.131407.vip" : "//localhost:9002",
  ...
  },
  {
    ...
    title: "青椒鱿鱼派",
    desc: "每天写一写，总会变厉害的",
    entry: isProd() ? "https://blog.131407.vip" : "//localhost:9003",
